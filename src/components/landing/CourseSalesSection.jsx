...
const benefits = [
  { icon: Shield, text: "Uppfyll SSM-, IVO- och Läkemedelsverkets krav" },
  { icon: Zap, text: "Helhetsbild av alla regelverk – klart på en dag" },
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            Från idé till<br />
            <span className="text-accent">startklar klinik</span>
            </h2>
            <p className="mt-4 font-body text-white/70 leading-relaxed">
            En övergripande introduktion till alla regelverk som styr er verksamhet — 
            patientsäkerhet, journalföring, dataskydd, hygien, marknadsföring, ledningssystem och mer. 
            Skapad av jurister, anpassad för kliniker med estetisk verksamhet.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-8 space-y-6">
              ...
              <div>
                <div className="inline-flex items-center gap-2 bg-accent/20 border border-accent/30 text-accent text-xs font-semibold uppercase tracking-wider px-3 py-1 rounded-sm mb-4">
                  Komplett startpaket för din klinik
                </div>
                ...
                <p className="text-white/50 text-xs mt-1">Grundkurs – helhetsbild av alla regelverk</p>
              </div>

              {/* Whats included */}
              <ul className="space-y-2">
                {[
                  "Patientsäkerhet, journalföring & dataskydd",
                  "Marknadsföring, läkemedel & MTP",
                  "Hygien, ledningssystem & egenkontroll",
                  "Kunskapskontroll (quiz) per avsnitt",
              ...
              <p className="text-center text-xs text-white/40">
                Fördjupa dig med Premiummoduler — {SINGLE_PRICE_LABEL}
              </p>
            </div>
          </motion.div>
        </div>
