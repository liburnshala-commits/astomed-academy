...
export default function AboutSection() {
  return (
    <section id="om-oss" className="py-20 md:py-32 bg-secondary/30">
      <div className="max-w-7xl mx-auto px-6">
        <motion.div
          ...
          className="max-w-2xl"
        >
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-accent mb-3">Samarbete</p>
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-6">
          {partners.map((partner, index) => (
            ...
            >
              ...
              <h3 className="font-heading text-xl font-semibold text-foreground">{partner.name}</h3>
              <p className="text-sm font-medium text-accent mt-1">{partner.role}</p>
