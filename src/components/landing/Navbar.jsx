    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#042732] border-b border-white/10">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        {!searchOpen && (
          <div className="hidden md:flex items-center gap-6">
            <a href={navHref("#kurser")} className="text-sm font-body font-medium text-white/80 hover:text-white transition-colors">Grundkurs</a>
      ...
      {open && (
        <div className="md:hidden bg-[#042732] border-b border-white/10 px-6 py-4 space-y-3">
          <a href={navHref("#kurser")} onClick={() => setOpen(false)} className="block text-sm font-body font-medium text-white/80">Grundkurs</a>
